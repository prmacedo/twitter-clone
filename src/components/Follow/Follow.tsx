...
export function Follow({ name, user, img }: FollowProps) {
  return (
    <Link to={"not-found"} className="follow grid gap-x-2.5 border-b-2 border-dark-7 dark:border-dark-4 bg-dark-8 dark:bg-dark-2 hover:bg-dark-7 dark:hover:bg-dark-3 py-2.5 px-4 cursor-pointer">
